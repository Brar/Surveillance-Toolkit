```{r}
#| label: fig-bw-ref
#| fig-cap: "A histogram in 50 g steps with density curve (a) and a boxplot (b) of the birth weights of the patients contained in this analysis. Vertical lines in the boxplot represent the 25%, 50% and 75% quantiles, the diamond represents the pooled arithmetic mean."
