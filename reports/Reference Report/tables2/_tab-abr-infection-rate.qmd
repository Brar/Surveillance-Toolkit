...
data |>
  ...
  cols_width(starts_with("Q") ~ pct(8)) |>
  gt::tab_stub_indent(
    rows = gt::everything(),
  ...
  tab_footnote(
    footnote = md(
      paste0(
        ...
        "} = \\frac{\\text{",
        "No of antibiotic resistant pathogens in infections",
        "}}{\\text{",
        "No of infections where a pathogen was detected",
        "}} \\times ",
