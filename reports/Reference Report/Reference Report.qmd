...
trnsl <- list(
  ...
  sepsisTable = list(
    ...
    PooledMeanFootnote = "The pooled mean of the incidence density. It is calculated by summing the number of infections in all departments and dividing by the sum of patient days in all departments.",
    Q1Footnote = "The first quartile (Q1) separates the quarter of departments with the lowest incidence densities from the three quarters with higher incidence densities.",
    MedianFootnote = "The median separates the half of the departments with the lower incidence densities from the half with the higher incidence densities.",
    Q3Footnote = "The third quartile (Q3) separates the quarter of the departments with the highest incidence densities from the three quarters with lower incidence densities."
  ),
  vcSepsisTable = list(
    ...
    PooledMeanFootnote = "The pooled mean of the vascular-catheter-associated sepsis rate. It is calculated by adding up the number of sepsis cases associated with the respective vascular catheter in all departments and dividing it by the sum of the patient days in all departments during which the respective vascular catheter was present",
    Q1Footnote = "The first quartile (Q1) separates the quarter of departments with the lowest vascular-catheter-associated sepsis rates from the three quarters with higher vascular-catheter-associated sepsis rates.",
    MedianFootnote = "The median separates the half of the departments with the lower vascular-catheter-associated sepsis rates from the half with the higher vascular-catheter-associated sepsis rates.",
    Q3Footnote = "The third quartile (Q3) separates the quarter of departments with the highest vascular-catheter-associated sepsis rates from the three quarters with lower vascular-catheter-associated sepsis rates."
  )
)
```
