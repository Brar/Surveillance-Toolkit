...
When comparing data with the information on pathogens presented in @tbl-agent-per-infection-rate, please also have a look at the infectious agent detection rates presented in @tbl-infectious-agent-detection-rate.
