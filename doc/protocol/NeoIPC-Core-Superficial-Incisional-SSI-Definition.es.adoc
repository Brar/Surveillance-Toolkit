...
*El término médico, a efectos de la aplicación de los criterios de ISQ de la NHSN, puede interpretarse como un cirujano, un médico de enfermedades infecciosas, un médico de urgencias, otro médico del caso o la persona designada por el médico (enfermero o asistente médico).
