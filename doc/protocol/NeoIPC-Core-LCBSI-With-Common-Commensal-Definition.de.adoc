.Zweifach im Labor bestätigte Blutstrominfektion mit gewöhnlichen Kommensalen nachgewiesen
[%unbreakable]
****
...
.Im Labor bestätigte Blutstrominfektion mit gewöhnlichen Kommensalen und fünftägige Behandlung
[%unbreakable]
****
. **Ein gewöhnlicher Kommensale wird aus EINER Blutkultur und/oder Liquorkulturprobe gewonnen**
+
